...
hl.bind(mainMod .. " + U",         hl.dsp.exec_cmd(terminal .. " -e ncmpcpp"))
hl.bind(mainMod .. " + I",         hl.dsp.exec_cmd(terminal .. " -e newsboat"))
hl.bind(mainMod .. " + O",         hl.dsp.exec_cmd(terminal .. " -e pulsemixer"))
hl.bind(mainMod .. " + N",         hl.dsp.exec_cmd(terminal .. [[-e nvim -c "lua require('neowiki').open_wiki()"]]))
